...
public class UsuarioIT {
    ...
    @Test
    public void bucarUsuarios_BuscarTodosUsuarios_RetornarUsuariosComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.get(0)).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.get(0).getId()).isEqualTo(100);
        org.assertj.core.api.Assertions.assertThat(responseBody.get(0).getUsername()).isEqualTo("ana@email.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.get(0).getRole()).isEqualTo("ADMIN");

        org.assertj.core.api.Assertions.assertThat(responseBody.get(1)).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.get(1).getId()).isEqualTo(101);
        org.assertj.core.api.Assertions.assertThat(responseBody.get(1).getUsername()).isEqualTo("bia@email.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.get(1).getRole()).isEqualTo("CLIENTE");

        org.assertj.core.api.Assertions.assertThat(responseBody.get(2)).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.get(2).getId()).isEqualTo(102);
        org.assertj.core.api.Assertions.assertThat(responseBody.get(2).getUsername()).isEqualTo("silva@email.com");
    ...
    public void listarUsuarios_ComUsuarioSemPermissao_RetornarErrorMessageComStatus403() {
        List<UsuarioResponseDto> responseBody = responseBody = testClient
                .get()
                .uri("/api/v1/usuarios")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
                .exchange()
    ...
    @Test
    public void bucarUsuarios_TrazerNenhumUsuario_RetornarNenhumUsuarioComStatus404() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/usuarios")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
